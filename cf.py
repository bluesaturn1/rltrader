...
DENSE_UP_RESULTS_TABLE = 'dense_up_results'  # finding & training table
...
# cf.py에 추가
# 모델 훈련 시 사용하는 검증 기간
MODEL_VALIDATION_END_DATE = '2023-01-15'
...
# 검증 설정
VALIDATION_START_DATE = '2025-03-01'  # 검증 기간 시작 날짜 설정
VALIDATION_END_DATE = '2025-04-11' # 검증 기간 종료 날짜 설정
# 오늘 기준 검증
# 현재 날짜 가져오기
now = datetime.now()
