...
FIREARROW_RESULTS_TABLE = 'firearrow_results'  # finding & training table
...
# 검증 설정
VALIDATION_START_DATE = '20230401'  # 검증 기간 시작 날짜 설정
VALIDATION_END_DATE = '20230430'    # 검증 기간 종료 날짜 설정
