...
# imi1_accout="5299617110"  # obgynjk
# imi1_accout="4219873411" ## obgynjh
# imi1_accout="8163982411" ## obgynjh 모의투자
imi1_accout="5272283610" # obgynji
...
# openapi 시작일자
openapi_startdate = '20200101'
# daily_buy_list database를 과거 어떤 시점 부터 만들 것인지 설정 하는 변수
start_daily_buy_list='20200101'
...
# api를 최대 몇 번까지 호출 하고 봇을 끌지 설정 하는 옵션 (1000넘어가면 과도한 요청 에러나옴)
max_api_call = 999
