...
def summarize_performance_by_date(performance_df):
    """
    performance_df를 날짜별로 요약하고, 각 날짜별 정보를 문자열로 반환합니다.
    """
    summary_messages = []
    
    # 날짜별로 그룹화
    date_groups = performance_df.groupby('pattern_date')
...
def main():
    ...
    settings['model_name'] = 'fire_xgboost'
